...
#### [4.5.2](https://github.com/kinde-oss/kinde-auth-pkce-js/compare/4.5.1...4.5.2)

- chore(deps): update dependency rollup to v4.63.3 [`#172`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/172)
- chore(deps): update dependency release-it to v21.0.3 [`#171`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/171)
- chore(deps): update dependency typescript-eslint to v8.70.0 [`#168`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/168)
- chore(deps): update dependency lint-staged to v17.5.1 [`#169`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/169)
- Fix/refresh storm from tab sync [`#165`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/165)
- chore(deps): update dependency @kinde/js-utils to v0.32.1 [`#167`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/167)
- chore(deps): bump js-yaml from 3.15.0 to 3.15.2 [`#166`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/166)
- chore(deps): update dependency jest to v30.5.1 [`#159`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/159)
- chore(deps): update dependency globals to v17.12.0 [`#158`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/158)
- chore(deps): update dependency eslint to v10.10.0 [`#157`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/157)
- chore(deps): update dependency release-it to v21.0.2 [`#156`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/156)
- chore(deps): update dependency eslint-plugin-jest to v29.16.6 [`#155`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/155)
- chore: release v4.5.1 [`#145`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/145)
- fix: map legacy org_code option to auth URL in login/register/createOrg [`#152`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/152)
- chore: enforce dependency release-age cooldown [`#146`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/146)
- fix: setup initial framework to prevent a refresh storm [`59a5b8d`](https://github.com/kinde-oss/kinde-auth-pkce-js/commit/59a5b8dd09bd47d79ef026c2a204a4ae1078c9b8)
- chore(deps): update dependency rollup to v4.62.3 [`daa106b`](https://github.com/kinde-oss/kinde-auth-pkce-js/commit/daa106b05d2ba739577eadb983e55756a97117a3)
- chore(deps): update dependency rollup to v4.62.4 [`72b5b71`](https://github.com/kinde-oss/kinde-auth-pkce-js/commit/72b5b71668e0133fc2dadd66bd2dd34d4b0b5fe0)

#### [4.5.1](https://github.com/kinde-oss/kinde-auth-pkce-js/compare/4.5.0...4.5.1)

> 4 August 2026

- chore: release v4.5.0 [`#115`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/115)
- fix: address issues with isAuthenticated and stubExpoSecureStore [`#142`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/142)
- chore(deps): update jest monorepo to v30 [`#137`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/137)
- chore(deps): migrate to ESLint 10 with flat config [`#141`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/141)
- fix: have test createMockJWT to prevent gitGuardian flagging fake token as leaked [`#139`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/139)
- chore(deps): update dependency rollup to v4 [`#135`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/135)
- chore(deps): update dependency prettier to v3.9.6 [`#122`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/122)
- chore(deps): update dependency lint-staged to v17 [`#134`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/134)
- chore(deps): update dependency husky to v9 [`#133`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/133)
- chore(deps): update dependency @rollup/plugin-typescript to v12 [`#129`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/129)
- chore(deps): update dependency rollup-plugin-delete to v3 [`#136`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/136)
- fix(deps): update dependency @kinde/js-utils to ^0.31.0 [`#123`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/123)
- chore(deps): update dependency @rollup/plugin-node-resolve to v16 [`#127`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/127)
- chore(deps): update dependency @types/node to v25.9.5 [`#119`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/119)
- chore(deps): update dependency @rollup/plugin-babel to v7 [`#126`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/126)
- chore(deps): update dependency @rollup/plugin-terser to v1 [`#128`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/128)
- chore(deps): update dependency eslint-config-prettier to v10 [`#131`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/131)
- chore(deps): update dependency release-it to v20.2.1 [`#120`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/120)
- chore(deps): update dependency @rollup/plugin-terser to ^0.4.0 [`#121`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/121)
- chore(deps): update actions/setup-node action to v7 [`#125`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/125)
- chore(deps): update actions/checkout action to v7 [`#124`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/124)
- fix: ensure we verify that on logout, that we cancel any active refreshing [`#118`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/118)
- Allow getAccessToken to refresh [`#117`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/117)
- fix: ensure user is hydrated on token refresh [`#116`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/116)
- chore(deps): bump undici and release-it [`9d4a91b`](https://github.com/kinde-oss/kinde-auth-pkce-js/commit/9d4a91b8d98e0a44700949a5cb2393b8d151fb83)
- fix: addres issues with isAuthenticated and stubExpoSecureStore [`efe9eea`](https://github.com/kinde-oss/kinde-auth-pkce-js/commit/efe9eea81fed88a1219b6b9ef00836524317f69a)
- chore: apply CRAI nitpick changes to ensure the changes to isTokenValid don't cause breaking changes. [`d234c1f`](https://github.com/kinde-oss/kinde-auth-pkce-js/commit/d234c1fdbf2c59ebbc53f3819ecb8ac52c552094)

#### [4.5.0](https://github.com/kinde-oss/kinde-auth-pkce-js/compare/4.4.0...4.5.0)

> 10 June 2026

- chore(deps): update github/codeql-action action to v4 [`#114`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/114)
- chore(deps): update actions/setup-node action to v6 [`#113`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/113)
- chore(deps): update actions/checkout action to v6 [`#112`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/112)
- chore(deps): update dependency rollup-plugin-dts to v6.4.1 [`#111`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/111)
- chore(deps): update dependency release-it to v20.2.0 [`#110`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/110)
- chore(deps): update dependency @types/node to v25.9.2 [`#109`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/109)
- chore(deps): update dependency prettier to v3.8.4 [`#107`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/107)
- chore(deps): update dependency ts-jest to v29.4.11 [`#108`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/108)
- chore(deps): update dependency @kinde/js-utils to v0.30.1 [`#106`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/106)
- Release/v4.4.0 [`#104`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/104)
- Fix/multi tab token syncing [`#103`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/103)
- chore(deps): bump lodash and release-it [`#100`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/100)
- fix: restore session on localhost with custom auth domain [`#94`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/94)
- fix: restore session on localhost with custom auth domain and added tests for the cases [`956e0e5`](https://github.com/kinde-oss/kinde-auth-pkce-js/commit/956e0e5e5370b351f85cdf3d91a0df91f6c3e6d4)
- chore: delete pnpm-lock.yaml [`2e2da95`](https://github.com/kinde-oss/kinde-auth-pkce-js/commit/2e2da9597eb1611043984d639eeb1cb88ac54ea6)
- fix: add a tabSync method to help ensure refreshing tokens supports multiple tabs [`5259a4c`](https://github.com/kinde-oss/kinde-auth-pkce-js/commit/5259a4c7e8fa853fd0c3cb71ccf0da39d9f871dd)

#### [4.4.0](https://github.com/kinde-oss/kinde-auth-pkce-js/compare/4.3.0...4.4.0)

> 30 April 2026

- refactor: migrate to js-utils storage [`#92`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/92)
- Add invitation functionality to createKindeClient [`#93`](https://github.com/kinde-oss/kinde-auth-pkce-js/pull/93)
- fix: ensure we only have one copy of js-utils being accessed by the store [`b2548c4`](https://github.com/kinde-oss/kinde-auth-pkce-js/commit/b2548c42f7837e3b1f43dd291e9654c51efbfb5b)
- chore: remove previously deleted files [`0f34768`](https://github.com/kinde-oss/kinde-auth-pkce-js/commit/0f34768d7d8cb4a271cf56519925ff660c56b0cb)
- feat: use js-utils LocalStorage [`f405173`](https://github.com/kinde-oss/kinde-auth-pkce-js/commit/f405173e7ffa3800f50bf26d01fef2ab6bcd9e90)
...
- chore: release v4.3.0 [`c714add`](https://github.com/kinde-oss/kinde-auth-pkce-js/commit/c714add1ec638854d3f1410e56433e7a768f34b5)
...
- ci: bump setup node [`f5dc9ba`](https://github.com/kinde-oss/kinde-auth-pkce-js/commit/f5dc9ba81c7dfc4f3362ae7508c1c18c94300d35)
